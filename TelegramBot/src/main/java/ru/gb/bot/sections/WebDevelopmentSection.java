...
public class WebDevelopmentSection implements SectionHub {
    ...
    public WebDevelopmentSection(BackendPublicationService publicationService, BackendUserService userService) {
    ...
    public Page<BackendPublicationDto> getListOfArticle(Optional<String> authorName,
        ...
        Optional<String> menuItem = Optional.ofNullable(K_WEB_DEV_SECTION.getCommandButtonName());
    ...
    public void addArticle(BackendPublicationDto publication) {
        Publication.MenuItem item = Publication.MenuItem.WebDevelopment;
